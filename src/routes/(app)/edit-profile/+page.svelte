...
<form method="POST" class="space-y-4">
    ...
    <div class="flex gap-2">
        <button
            type="button"
            class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-md font-medium transition-colors duration-200 w-full"
            onclick={getLocation}
        >
        ...
        <button
            type="button"
            class="bg-gray-400 hover:bg-gray-500 text-white px-4 py-2 rounded-md font-medium transition-colors duration-200 w-full"
