...
<div class="max-w-6xl mx-auto p-8 font-sans">
    <header class="flex flex-col md:flex-row justify-between items-center mb-8 pb-4 border-b-2 border-gray-200">
    ...
    <main>
        <section>
            <h2 class="text-gray-700 text-xl md:text-2xl font-semibold mb-6">Tennis Players Near You</h2>
